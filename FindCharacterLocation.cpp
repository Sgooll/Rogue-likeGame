...
#include "FindCharacterLocation.h"
...
UFindCharacterLocation::UFindCharacterLocation(FObjectInitializer const& object_initializer)
{
	NodeName = TEXT("Find Random Location");
}

EBTNodeResult::Type UFindCharacterLocation::ExecuteTask(UBehaviorTreeComponent& owner_comp, uint8* node_memory)
{
